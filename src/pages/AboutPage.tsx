...
const AboutPage: React.FC = () => {
  return (
    ...
    <h2>What's "B" meaning?</h2>
    <p>"B" means "Blue", to help you stay sharp, we’ve chosen calming yet powerful <span className="italic font-bold">blue</span> as the main color theme.</p>
    <h2>How to use?</h2>
    ...
    <img src={howToUse} alt="An image of how to use this app" />
