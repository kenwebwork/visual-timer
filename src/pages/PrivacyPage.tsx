...
function PrivacyPage(){
  return (
    <>
      ...
      <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at {APP_URL}, unless otherwise defined in this Privacy Policy.</p>
      ...
      <p className="ml-6">Please visit here: <Link to='/contact'>Contact Page</Link></p>
    </>
  );
};
